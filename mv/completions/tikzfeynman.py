...
from mv.completions.completion import operator_completions
...
def proc_body(g: nx.Graph) -> str:
    ...
    for a, b, data in g.edges.data():
        ...
        # mv.completions.completion.get_connecting_edge are already in the right
        # order. The ones that aren't are the external edges, these need to be
        # ordered
