...
from mv.tensormethod.core import eps, Operator
from mv.tensormethod.sm import L, Q, db, ub, eb, H

from mv.completions.core import EffectiveOperator
...
EFF_OPERATORS["82"] = EffectiveOperator("82", o82)
